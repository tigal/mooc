...
def get_admin_models():
    ...
    return [(CertificateCourse, ), (StudentAnswerQuestion, ), (StudentFinishedTheme, ), (StudentFinishedCourse, ), (StudentFinishedTest, ), (StudentAnswerTestQuestion, ), (Subscription, ), (Question, ), (Course, ), (CourseTheme, ), (Test, ), (TestQuestion, ), (UserDefinedCourse, ), (UserDefinedTheme, ), (Schedule, ), (Provider, ), (CertificateSpec, ), (Specialization, ), (Student, )]
